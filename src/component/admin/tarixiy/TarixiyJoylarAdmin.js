...
function TarixiyJoylarAdmin() {
    ...
    function searchVal() {
        ...
        if (!!searchVal) axios.get(apiTravel + 'places/?category=6&search=' + searchVal).then(res => setAdminHotel(res.data.results))
        else getHotelsAdmin();
    }
    ...
    return (
        <Container>
            ...
            <h1
                ...
                className="text-center fw-bold text-dark">Tarixiy joylar Admin</h1>

            <div className="mb-5"
                style={{ display: "flex", justifyContent: "space-between", flexDirection: "row" }}>
                <Button onClick={openAddModal} color="primary" className="px-5 py-2 fs-5 fw-medium">Tarixiy joy qo'shish</Button>
                <div>
                    <InputGroup>
            ...
            <Modal size="xl" isOpen={addModal} scrollable>
                <ModalHeader toggle={openAddModal}><h3>Tarixiy joy qo'shish</h3></ModalHeader>
            ...
            <Modal size="xl" scrollable isOpen={editModal}>
                <ModalHeader toggle={openEditModal}><h3>Tarixiy joyni tahrirlash</h3></ModalHeader>
                <ModalBody className="modal__label">
                    <Row className="w-100">
                        <Col className="col-12 col-md-4">
                            <Label for="image">Image: Majburiy</Label>
            ...
            <Modal size="lg" isOpen={deleteModal} scrollable>
                <ModalHeader toggle={openDeleteModal}><h3>Tarixiy joyni o'chirish</h3></ModalHeader>
...
export default TarixiyJoylarAdmin;